...
public class DemoAppModule extends ReactContextBaseJavaModule implements ILiveIDResponseListener, IOnQRScanResponseListener {
     ...
     */
    @ReactMethod
    public void isLiveIdRegistered(Promise promise) {
    ...
    private void getTenantInfo(Promise promise) {
        ...
        SdkInformationDataModel sdkInformationDataModel = new SdkInformationDataModel();
        sdkInformationDataModel.setLicenseKey(newLicenseKey);
        sdkInformationDataModel.setTenant(tenant);
        sdkInformationDataModel.setClientTenant(clientTenant);
        sdkInformationDataModel.setDID(DID);
        sdkInformationDataModel.setPublicKey(publicKey);
        sdkInformationDataModel.setSdkVersion(SdkVersion);
        Gson gson = new Gson();
