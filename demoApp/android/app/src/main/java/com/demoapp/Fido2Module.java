...
public class Fido2Module extends ReactContextBaseJavaModule {
    ...
    Fido2Module(ReactApplicationContext context) {
        super(context);
    }
    ...
    private void enrollBiometricData(Promise promise) {
        MainActivity activity = (MainActivity) Objects.requireNonNull(getCurrentActivity());
    ...
    private void getTenantInfo(Promise promise){
        ...
        Log.d("Datta>>>",""+dataModel.licenseKey);
        Log.d("Datta>>>",""+dataModel);
        Gson gson = new Gson();
    ...
    private void initWallet(Promise promise) {
        ensureSDKUnlocked();
        SharedPreferences sharedPref = Objects.requireNonNull(getCurrentActivity())
...
//import java.util.Objects;
//
//public class Fido2Module extends ReactContextBaseJavaModule implements ILiveIDResponseListener {
...
//        mLiveIDScannerHelper = new LiveIDScannerHelper(context, this);
...
//        ILiveIDResponseListener.super.onFaceFocusChanged(b, s);
//    }
//
//    @Override
//    public void expressionDidReset(String s) {
//        ILiveIDResponseListener.super.expressionDidReset(s);
//    }
//
//    @Override
//    public void onLivenessCheckStarted() {
//        ILiveIDResponseListener.super.onLivenessCheckStarted();
//    }
//}