...
export interface Spec extends TurboModule {
    ...
    registerTenantWith(tag: string, community: string, dns: string): Promise<boolean>;
    ...
    resetSDK(tag: string, community: string, dns: string, licenseKey: string, reason: string): Promise<boolean>;
    ...
    registerNationalIDWithLiveID(data: Object, face: string, proofedBy: string): Promise<boolean>;
    registerDrivingLicenceWithLiveID(data: Object, face: string, proofedBy: string): Promise<boolean>;
    registerPassportWithLiveID(data: Object, face: string, proofedBy: string): Promise<boolean>;
}
declare const _default: Spec;
export default _default;
//# sourceMappingURL=NativeBlockidplugin.d.ts.map